...
while ($subject = mysql_fetch_assoc($result)) {
  ...
  $dummyVideo = ($descriptionId==11? 'img/uploadVideo.jpg' : 'img/sorryVideo.svg');
...
<body>
            ...
            <article class="span12">
              <div class="inner-1">
                ...
                <div style="width:auto; margin:auto;">
                  ...
                  <div class="i-comm"><i class="icon-comment"></i>  <a href="#comments_tab" data-toggle="tab">Community</a></div>
                  <div class="clear"></div>
                  <hr>
                </div>
                <article class="span8">
                  <div class="row">
                    <div class="tab-content" style="overflow:none">
                      <div class="tab-pane active" id="story-tab">
                        ...
                        <?php if ($videoLink=="img/uploadVideo.jpg" || $videoLink=="img/sorryVideo.svg"){?>
                        ...
                        <?php if ($_SESSION[ "uid"] !="" || $_SESSION[ "uid"] !=null){ if ($descriptionId==10) {?>
                          <div class="followDetails"><span><a onclick="actionForm('<?php echo $projectId; ?>', 0)" class="btn btn-success  pull-right" style="font-weight:bold;">Follow</a></span></div>
                        ...
                        <?php } else if ($descriptionId==12) {?>
                          <span><a onclick="actionForm('<?php echo $projectId; ?>', 5)" class="btn btn-warning  pull-right" style="font-weight:bold;"></i>Unfollow</a></span>
                        <?php } }else { ?>
                          <span><a href="../login_page.php" class="btn btn-success pull-right" style="font-weight:bold;">Follow</a></span> 
                        <?php } ?>
 ...
 -->                                <div  style="display:none">
  ...
  stLight.options({
    ...
    var disqus_shortname = 'ourcommonfuture'; // required: replace example with your forum shortname
