                ...
                <div class="nav-collapse nav-collapse_  collapse pull-right">
                  <ul class="nav sf-menu pull-right" >   
                    ...
                    <li class="dropdown" id="tabs">
                      <a href="../projects/" target="_self" data-toggle="dropdown" class="dropdown-toggle" >PROJECTS <span style="margin-top:10px" class="caret"></span></a>
          ...
          <div class="container">
            <div class="row">
              <div class="tab-content" style="min-height:250px; overflow:none">
                <div class="tab-pane active" id="tab1" >
                  ...
                  <div class="span10">
                    ...
                    <div class="pagination">
                      <ul  id="totalProjectPagination" style="display:inline; margin:auto" class="tsc_pagination tsc_paginationB tsc_paginationB04">                                     
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-pane" id="my-projects" style = "height:auto; min-height:400px; margin:10px auto;">
                ...
                <div class="tab-pane" id="create-project" style="<?php if($_SESSION["uid"]==""){?>display:none;<?php }else{?>font-size:90%;<?php }?>">
