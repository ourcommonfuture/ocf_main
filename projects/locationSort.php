...
<?php 	
	...
	$query = "SELECT  * FROM  `PROJECT` WHERE `PUBLISH_STATUS`='now' AND `LOCATION` LIKE '%$sortByLocation%' OR `COUNTRY` LIKE '%$sortByLocation%' ORDER BY `ID` DESC";
	...
	///////////////////////////////////////////////////////////////////////////////////////////	
	$totalRowsResult = mysql_query( "SELECT  * FROM  `PROJECT` WHERE `PUBLISH_STATUS`='now' AND `LOCATION` LIKE '%$sortByLocation%' OR `COUNTRY` LIKE '%$sortByLocation%'", $connection);
